...
class TestProductModel(unittest.TestCase):
    ...
    def test_product_repr(self):
        ...
        product.id = 1  # Simulate a saved product
        self.assertEqual(repr(product), "<Product Fedora id=[1]>")

    def test_deserialize_missing_key(self):
        """It should raise an error when a required field is missing"""
        data = {
            "description": "Missing name",  # Missing the required "name" field
            "price": "12.50",
            "available": True,
            "category": "CLOTHS"
        }
    ...
    def test_get_product(self):
        ...
        # Verify the found product matches
    ...
    def test_deserialize_invalid_available_type(self):
        ...
        with self.assertRaises(DataValidationError):
            product.deserialize({
                "name": "Test Product",
                "description": "Invalid available field",
                "price": "19.99",
    ...
    def test_update_without_id(self):
        product = Product(name="No ID", description="Failing", price=5.0, available=True, category=Category.TOOLS)
        with self.assertRaises(DataValidationError):
            product.update()
